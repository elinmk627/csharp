...
namespace CommandExam {
    class MainWindowViewModel : INotifyPropertyChanged {
        ...
        public MainWindowViewModel() {
            ...
            Emps.Add(new Emp { Ename = "홍길동", Job = "doctor" });
            Emps.Add(new Emp { Ename = "김길동", Job = "programer" });
            Emps.Add(new Emp { Ename = "정길동", Job = "programer" });
            Emps.Add(new Emp { Ename = "박길동", Job = "designer" });
            Emps.Add(new Emp { Ename = "성길동", Job = "designer" });
